...
-- CreateIndex
CREATE UNIQUE INDEX "Analytics_path_key" ON "Analytics"("path" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "NewsSource_country_name_category_key" ON "NewsSource"("country" ASC, "name" ASC, "category" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Newsletter_email_key" ON "Newsletter"("email" ASC);
